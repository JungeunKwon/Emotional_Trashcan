...
public class Trash2Database {

    private static final String TAG = "Trash2Database";
    private static final String DATABASE_NAME = "Trash2Database.db";
    private static final int DATABASE_VERSION = 1;
    private Trash2Database.DatabaseHelper mDbHelper;

    private static SQLiteDatabase INSTANCE;

    public static SQLiteDatabase getDatabase(Context context) {
        if (INSTANCE == null) {
            INSTANCE = new Trash2Database.DatabaseHelper(context).getWritableDatabase();
        }
        return INSTANCE;
    }
