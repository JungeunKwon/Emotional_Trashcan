...
public class GoalDatabase {   private static final String TAG = "GoalDatabase";
...
/*
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            db.execSQL(GoalSchema.SQL_TABLE_CREATE);
            db.execSQL(GoalDetailSchema.SQL_TABLE_CREATE);
        }
